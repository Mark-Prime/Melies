    ...
    <div class="demo__event-container">
        <div class="demo__event" class:demo__event--bookmark={!event.isKillstreak}>
            ...
            <input 
                ...
                type="number"
            />
            <a class="demo__event-delete tooltip tooltip--left" data-tooltip="Delete Event" style={"--kills: 0"} href="/" on:click={() => deleteEvent(demo_i, i)}>
                -
            </a>
        </div>
    </div>
...
<style lang="scss">
    .demo {
        ...
        &__event {
            ...
            grid-template-columns: min-content 1fr .4fr 26px;
