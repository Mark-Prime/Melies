    ...
    <div class="killstreaks">
        {#each killstreaks as killstreak}
            {#if parsed_demo.data.users[killstreak.kills[0].killer]}
                <div class={"demo demo__killstreaks " + ((killstreak.selected || killstreak.selected_as_bookmark || getLifeFromKillstreak(killstreak)?.selected) && "demo--selected")}>
...
.demo {
    ...
    &__killstreaks {
        grid-template-columns: .3fr 1fr 1fr 1fr 1fr min-content;
    }
